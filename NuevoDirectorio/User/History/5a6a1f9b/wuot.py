...
class User(db.Model):
    ...
    password=db.Columns(db.String(255),nullable=False)
    registered_on=db.Column(db.Datetime, nullable=False)
    admin=db.Column(db.Boolen,nullable=False,default=False)
    ...
    class Images(db.Model):
        __tablename__='user_imaages'
        id_imges= db.Column(db.Integer,primary_key=True)
